...
Usage:
  python tools/export_shelf_geometry.py --project pantry
Outputs: projects/<project>/nesting_geometry.json
"""
...
def main():
    parser = argparse.ArgumentParser(description='Export shelf geometry for nesting UI.')
    ...
    # Import load_shelves from project's scripts
    scripts_dir = project_dir / 'scripts'
    sys.path.insert(0, str(scripts_dir))
    from generate_nested_layouts import load_shelves

    print(f"Loading shelves for project '{args.project}'...")
    shelves = load_shelves(project_dir)
    ...
    out = project_dir / "nesting_geometry.json"
